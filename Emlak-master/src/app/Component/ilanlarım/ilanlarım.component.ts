...
@Component({
  selector: 'app-ilanlarım',
  templateUrl:'./ilanlarım.component.html',
  styleUrls: ['./ilanlarım.component.scss']
})
export class IlanlarımComponent implements OnInit {
  Urunler:any;
  /*-----------------------------------------------------*/
  /*-----------------------------------------------------*/
  /*Urun detaı*/
  ...
  Sil(urunum:Urun) {
    this.fbServis.UrunSil(urunum.key).then(d => {
      this.router.navigate(['/ilanim']);
    });
  }
  Vazgec() {
